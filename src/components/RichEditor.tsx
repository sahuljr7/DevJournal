                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        <div>
                          <p className="text-[11px] font-bold uppercase tracking-tight truncate text-[var(--ink-color)]">
                            {norm.name}
                          </p>
                      ...
                      {norm.versions && norm.versions.length > 0 && (
                        <div className="mt-2 pt-2 border-t border-[var(--border-color)]">
                          <p className="text-[7px] uppercase font-bold text-[var(--muted-color)] flex items-center gap-1 mb-1 italic">
                            <HistoryIcon size={8} /> Revision History // {norm.versions.length}
                          </p>
                          <div className="flex flex-wrap gap-1">
                            {norm.versions.map((v, vi) => (
                              <button 
                                ...
                                className="text-[8px] bg-[var(--bg-color)] border border-[var(--border-color)] px-1.5 py-0.5 hover:border-[var(--ink-color)] transition-colors opacity-60 hover:opacity-100"
                                title={`Restore: ${v.name} (${new Date(v.timestamp).toLocaleString()})`}
                              >
                                v{vi + 1}
                              </button>
                            ))}
